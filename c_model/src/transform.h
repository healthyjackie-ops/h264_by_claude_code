...
/* Dequantize a 4x4 residual block (raster order, DC included) with the
 * active weightScale list (raster, flat = all 16):
 * d = ((c * w[i] * V(qp%6,pos)) << (qp/6) + 8) >> 4. */
