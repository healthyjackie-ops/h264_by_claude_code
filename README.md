...
**验证：141/141 向量对 ffmpeg (libavcodec 8.1) 逐字节 bit-exact**
（CAVLC/CABAC × baseline/main/high × 单/多 slice × I/P 帧序列共 135 个
...
## 下一步（docs/roadmap.md Wave 7+）

多参考/B 帧 → 加权预测 → ASO → RTL。
