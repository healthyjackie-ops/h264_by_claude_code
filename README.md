...
| 维度 | 支持 |
|---|---|
| 码流 | Annex-B 序列（IDR/P/**B 帧**·多参考·POC 重排，多 slice），EPB 去转义 |
...
**验证：175/175 向量对 ffmpeg (libavcodec 8.1) 逐字节 bit-exact**
（CAVLC/CABAC × baseline/main/high × 单/多 slice × I/P/B × 多参考 × 加权共 169 个
...
## 下一步（docs/roadmap.md Wave 10+）

temporal direct/b-pyramid → ASO → RTL。
